...
document.addEventListener("click", (event) => {
  ...
  if (
    ...
    !target.closest(".menu-item#notifications")
  ) {
    hideNotificationsPopup();
  }
});

// Close the notifications popup when pressing the "Escape" key
